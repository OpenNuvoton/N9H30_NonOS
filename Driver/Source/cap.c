 ...
 *
 * @param[in]   eIntType     Interrupt type. Including:
 *                           - \ref eCAP_MDINTF
 *                           - \ref eCAP_ADDRMINTF
 *                           - \ref eCAP_MEINTF
 *                           - \ref eCAP_VINTF
 ...
 * @param[in]   ePipeEnable     Enable pipe type. Including:
 ...
 *                              1 : Enable engine clock.
 *                              0 : Disable engine clock.
 * @param[out]  pePipeEnable    Pipe type. Including:
 *                              - \ref eCAP_BOTH_PIPE_DISABLE
 *                              - \ref eCAP_PLANAR
 *                              - \ref eCAP_PACKET
 *                              - \ref eCAP_BOTH_PIPE_ENABLE
 * @return      None
 *
 * @details     This function is used to get engine clock and pipe type.
 */
 ...
 *              setting shadow(update) register.
 */
...
/**
 * @brief      Set motion detection parameter extension.
 *
 ...
 * @return       None
 *
 * @details      This function is used to set motion detection parameter extension.
 */
...
/**
 * @brief      Get motion detection parameter extension.
 *
 ...
 * @return       None
 *
 * @details      This function is used to get motion detection parameter extension.
 */
...
/**
 * @brief      Set One shutter or continuous mode.
 *
 * @param[in]  bIsOneSutterMode      Enable One shutter.Including :
 *                                   1 :  Enable  One shutter mode.
 *                                   0 : Disable One shutter mode.
 * @return     None
 *
 * @details    This function is used to set one shutter or continuous mode.
 *             Image capture interface automatically disable the capture 
 *             interface after a frame bad been captured.
 */
...
/**
 * @brief      Get One shutter or continuous mode.
 *
 * @retval     1 : Disable one shutter mode
 * @retval     0 : Enable one shutter mode
 *
 * @details    This function is used to get one shutter or continuous mode.
 *             Image capture interface automatically disable the capture 
 *             interface after a frame bad been captured.
 */
 ...
 * @param[in]    u32Height  Cropping window height.
 *
 * @return       None.
 *
 ...
 * @param[out]   pu32Height  Cropping window height.
 *
 * @return       None.
 *
