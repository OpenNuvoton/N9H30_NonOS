 ...
 * $Revision: 1 $
 * $Date: 15/05/28 5:17p $
 * @brief    N9H30 FMI NAND driver source file
 *
 * @note
...
/** @addtogroup N9H30_FMI_NAND_Driver FMI NAND Driver
  @{
*/


/** @addtogroup N9H30_FMI_NAND_EXPORTED_FUNCTIONS FMI NAND Exported Functions
  @{
*/
/// @cond HIDDEN_SYMBOLS
...
static void n9h30_nand_command(struct mtd_info *mtd, unsigned int command, int column, int page_addr)
{
...
static __inline int _n9h30_nand_dma_transfer(struct mtd_info *mtd, const u_char *addr, unsigned int len, int is_write)
{
 ...
 * @buf:        data buffer
 */
static void n9h30_nand_write_page_hwecc(struct mtd_info *mtd, struct nand_chip *chip, const uint8_t *buf)
{
 ...
 */
static int n9h30_nand_read_page_hwecc_oob_first(struct mtd_info *mtd, struct nand_chip *chip, uint8_t *buf, int page)
{
    ...
    n9h30_nand_command(mtd, NAND_CMD_READOOB, 0, page);
    ...
    n9h30_nand_command(mtd, NAND_CMD_READ0, 0, page);
 ...
 */
static int n9h30_nand_read_oob_hwecc(struct mtd_info *mtd, struct nand_chip *chip, int page, int sndcmd)
{
    char * ptr=(char *)REG_NANDRA0;
...
int board_nand_init(struct nand_chip *nand)
{
    ...
    n9h30_nand = &g_n9h30_nand;
    memset((void*)n9h30_nand,0,sizeof(struct n9h30_nand_info));
    ...
    nand->cmdfunc = n9h30_nand_command;
    ...
    if (nand_scan_ident(&(n9h30_nand->mtd), 1, NULL)) {
    ...
    switch (mtd->writesize) {
        ...
        default:
            sysprintf("N9H30 NAND CONTROLLER IS NOT SUPPORT THE PAGE SIZE. (%d, %d)\n", mtd->writesize, mtd->oobsize );
    }
    ...
    // Redundant area size
    outpw(REG_NANDRACTL, n9h30_nand->m_i32SMRASize);
    ...
    // Set BCH algorithm
    outpw(REG_NANDCTL, (inpw(REG_NANDCTL) & (~0x007C0000)) | g_i32BCHAlgoIdx[n9h30_nand->eBCHAlgo]);
    // Enable H/W ECC, ECC parity check enable bit during read page
    outpw(REG_NANDCTL, inpw(REG_NANDCTL) | 0x00800080);
...
/*@}*/ /* end of group N9H30_FMI_NAND_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group N9H30_FMI_NAND_Driver */
